...
public class DigitalWatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        static final String TEST_STRING = "TOTO";
        ...
        String mHourString = DigitalWatchFaceUtil.TEST_STRING;
        ...
        private void setNewText(String text) {
            mHourString = text;
            //updatePaintIfInteractive(mTextPaint, text);
        }
...
//            if (mHourString == null)
//                mHourString = "toto";
            canvas.drawText(mHourString, mXOffset, mYOffset + 100, mColonPaint);
...
//                }
                ...
                String coco = config.getString("TEST_STRING");


            Log.e("TEST Config string", coco);
                //setNewText(coco);

                //uiUpdated = true;
//                if (Log.isLoggable(TAG, Log.DEBUG)) {
//                    Log.d(TAG, "Found watch face config key: " + "TEST_STRING" + " -> "
//                            + Integer.toHexString(color));
//                }

            setNewText(coco);

            if (updateUiForKey("TEST_STRING", coco)) {
                  uiUpdated = true;
               }
        ...
        private boolean updateUiForKey(String configKey, String text) {
            if (configKey.equals(DigitalWatchFaceUtil.TEST_STRING))
                setNewText(text);
            return true;
         }
